                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/admin/khan/thong-ke/top10-sp-theo-ngay">SP ban chay</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<div class="container">
    <h2>Top 10 san pham ton lau nhat</h2>
    <table class="table mt-2 table-responsive">
        ...
        <c:forEach items="${lst1}" var="sp" varStatus="i">
            <tr>
                <td>${sp.tenSP}</td>
                <td>${sp.soLuong}</td>
                <td>${sp.ngayNhap}</td>
