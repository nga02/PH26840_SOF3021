...
<div class="container" style="margin-top: 100px">
    <div class="col-3">
        <form action="/admin/khan/bill/tim-HD-theo-ma" method="get">
            <h4>Tim theo ma:</h4>
            <input name="ma" value="${ma}">
    ...
    <c:if test="${not listHD.isEmpty()}">
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${listHD.getContent()}" var="hd">
                <tr>
                    <td> ${hd.ma} </td>
                    <td> ${hd.ngayTao} </td>
                    ...
                    <td>${hd.sdt}</td>
                    <td>
                        <a href="/admin/khan/bill/detail-bill/${hd.id}" class="btn bg-danger mt-2">
                          Detail
                        </a>
                    </td>
                </tr>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <li class="page-item ${listHD.getNumber() + 1 > 1 ? "" : "disabled"} ">
                    <a class="page-link " href="?page=${listHD.getNumber()}" tabindex="-1">Previous</a>
                </li>

                <li class="page-item">
                    <span class="page-link"> ${listHD.getNumber() + 1} / ${listHD.getTotalPages()} </span>
                </li>

                <li class="page-item ${listHD.getNumber() + 1 lt listHD.getTotalPages() ?"":"disabled"}">
                    <a class="page-link" href="?page=${listHD.getNumber() + 2}">Next</a>
                </li>
            </ul>
        </nav>
<%--        <div>--%>
<%--            <c:if test="${listHD.getNumber() + 1 > 1}">--%>
<%--                <a href="?page=${listHD.getNumber()}">--%>
<%--                    Previous--%>
<%--                </a>--%>
<%--            </c:if>--%>
<%--            <span> ${listHD.getNumber() + 1} / ${listHD.getTotalPages()} </span>--%>
<%--            <c:if test="${listHD.getNumber() + 1 lt listHD.getTotalPages()}">--%>
<%--                <a href="?page=${listHD.getNumber() + 2}">--%>
<%--                    Next--%>
<%--                </a>--%>
<%--            </c:if>--%>
<%--        </div>--%>
