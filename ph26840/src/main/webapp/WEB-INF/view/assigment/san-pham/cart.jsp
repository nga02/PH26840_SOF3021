...
<div class="container" style="margin-top: 100px">
    ...
    <c:if test="${not gh.isEmpty()}">
        ...
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${gh}" var="sp" varStatus="i">
                <tr>
                    <td>${i.index + 1}</td>
                    <td> ${sp.idSP.tenSP} </td>
                    <td>
                        <form action="/khan/cart/update-quantity/${sp.id}" method="post">

                            <button type="submit" name="actions" value="giam">-</button>
                            <input aria-label="soLuong" class="input-qty" max="${sp.idSP.soLuong}" min="0" type="number"
                    ...
                    <td>
                        <a href="/khan/cart/remove-cart/${sp.id}" class="btn bg-danger mt-2">
        ...
        <a href="/khan/cart/check-out" class="btn btn-success"><i class="fa fa-shopping-cart"></i>Mua hàng</a>
