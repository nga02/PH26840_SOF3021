...
<div class="container mt-4">
    <form  method="post"
          action="/khan/order/thanh-cong">
        <input type="hidden" name="kh_tendangnhap" value="ngalt">

        <div class="py-5 text-center">
            <i class="fa fa-credit-card fa-4x" aria-hidden="true"></i>
            <h2>Thanh toan</h2>
            <p class="lead">Vui long kiem tra thong tin khach hang, thong tin gio hang truoc khi dat hang</p>
        </div>

        <div class="row">
            <div class="col-md-4 order-md-2 mb-4">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    <span class="text-muted">Thong tin gio hang</span>
                ...
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach items="${listGHCT}" var="sp" varStatus="i">
                        <tr>
                            <td> ${sp.idSP.tenSP} </td>
                            <td>
                               ${sp.soLuong}
                            </td>
<%--                            <td> ${sp.idSP.giaBan} </td>--%>
                            <td>${sp.idSP.giaBan * sp.soLuong}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Ma khuyen mai">
                    <div class="input-group-append">
                        <button type="submit" class="btn btn-secondary">Xac nhan</button>
                    </div>
                </div>
                <hr class="mb-4">
<%--                <div class="list-group-item d-flex justify-content-between">--%>
                    <span>Total(VND):</span><strong>${tong}</strong>
<%--                </div>--%>
<%--                <span >Total: <strong>${ tong }</strong>  VND</span>--%>
            </div>

            <div class="col-md-8 order-md-1 ">
                <h4 class="mb-3">Thong tin khach hang</h4>

                <div class="row">
                    <div class="col-md-12">
                        <label>Ho ten</label>
                        <input type="text" class="form-control"
                               value="${kh.ten}" disabled>
                    </div>
...
<%--                <h4 class="mb-3">Hinh thuc thanh toan:<span class="text-danger">Thanh toan khi nhan hang</span></h4>--%>
...
<%--                               value="1">--%>
<%--                        <label class="custom-control-label" for="httt-1">Tien mat</label>--%>
<%--                    </div>--%>
<%--                    <div class="custom-control custom-radio">--%>
<%--                        <input id="httt-2" name="httt_ma" type="radio" class="custom-control-input" required=""--%>
<%--                               value="2">--%>
<%--                        <label class="custom-control-label" for="httt-2">Chuyen khoan</label>--%>
<%--                    </div>--%>
<%--                    <div class="custom-control custom-radio">--%>
...
<%--                </div>--%>
                ...
                <button class="btn btn-primary btn-lg btn-block" type="submit" name="btnDatHang">Dat hang</button>
            </div>
        </div>
    </form>
