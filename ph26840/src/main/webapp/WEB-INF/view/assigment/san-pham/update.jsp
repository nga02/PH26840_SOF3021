...
<div class="container">
    ...
    <div class="right-container col-9 offset-2 mt-3">
        <h1 class="text-center"><b>UPDATE SAN PHAM KHAN</b></h1>
        <form action="/admin/khan/update/${sp.id}" method="post">
            <div class="form-group">
                <label>Ma sp</label>
                <input type="text" name="maSP" value="${sp.maSP}" class="form-control"/>

            </div>
            <div class="form-group">
                <label>Ten sp</label>
                <input type="text" name="tenSP" value="${sp.tenSP}" class="form-control"/>
            ...
            <div class="form-group">
                ...
                <select name="idThuongHieu" class="form-select">
                    <c:forEach items="${ lstTH }" var="th">
                        <option value="${th.id}" ${th.id==sp.idThuongHieu.id?"selected":""}>${th.ten}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="idMauSac" class="form-select">
                    <c:forEach items="${ lstMS }" var="ms">
                        <option value="${ms.id}" ${ms.id==sp.idMauSac.id?"selected":""}>${ms.ten}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="idChatLieu" class="form-select">
                    <c:forEach items="${ lstCL }" var="cl">
                        <option value="${cl.id}" ${cl.id==sp.idChatLieu.id?"selected":""}>${cl.ten}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="idLoai" class="form-select">
                    <c:forEach items="${ lstLoai }" var="loai">
                        <option value="${loai.id}" ${loai.id==sp.idLoai.id?"selected":""}>${loai.ten}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="giaNhap" value="${sp.giaNhap}" class="form-control"/>

            </div>

            <div class="form-group">
                <label>Gia ban</label>
                <input type="number" name="giaBan" value="${sp.giaBan}" class="form-control"/>

            </div>

            <div class="form-group">
                <label>Trang thai</label>
                <input type="radio" name="trangThai" id="r1" value="0" ${sp.trangThai == "0"?"checked":""} checked>
                <label>Het hang</label>
                <input type="radio" name="trangThai" id="r2" value="1" ${sp.trangThai == "1"?"checked":""}> <label>Con
                hang</label>
            </div>

            <div class="form-group">
                <label>Mo ta</label>
                <input type="text" name="moTa" value="${sp.moTa}" class="form-control"/>
            </div>

            <div class="mt-2">
                <div class="col-6">
                    <button class="btn btn-primary"
                            onclick="if(!confirm('Ban co chac chan muon cap nhat?')){return false;}else{return true;}">
                        Update
                    </button>
                </div>
