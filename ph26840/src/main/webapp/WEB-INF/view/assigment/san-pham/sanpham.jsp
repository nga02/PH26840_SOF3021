        ...
        <c:if test="${not lstSPCT.isEmpty()}">
            <div class="row">
                <c:forEach items="${lstSPCT.getContent()}" var="spct" varStatus="i">
                    <div class="col-md-4">
                        <a href="#detail/{{sp.id}}" class="nav-link">
                            <div class="card text-center mt-2">
                                <img src="https://product.hstatic.net/1000111569/product/khan_quang_choang_co_ks220__3__0102a62fbd054f0bb7dc4effdc2f0aa1_1024x1024.jpg"
                                     class="card-img-top mt-2  me-2" alt="..." width="150px"
                                     height="200px">

                                <div class="card-body">
                                    <h5 class="card-title"><a href="/admin/khan/detailKhan/${spct.id}"
                                                              class="nav-link">${spct.tenSP}</a></h5>
                                    <div class="text-black">
                                        <span>
                                             <a href="/admin/khan/detailKhan/${spct.id}"`><i class="fa fa-eye fa-lg"></i></a>
                                            <h4 class="card-text"><b>${spct.giaBan} <span>VND</span></b></h4>
                                        </span>
                                    </div>

                                    <!-- <a href="#" class="btn btn-primary">Add to card</a> -->
                                        <%--                                <a href="#" class="btn btn-buy bg-info"></a>--%>
                                </div>
                            </div>
                        </a>
                    </div>
